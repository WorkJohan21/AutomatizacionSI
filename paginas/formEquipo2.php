    ...
    <div id="page-container">
      <div id="content-wrap">
            <header class="tope">
                ...
                <h3 class="titulosHeader">Universidadd Tecnológica de Panamá<br>Departamento de Protocolo, Ceremonial y Eventos<br><i>"Camino a la excelencia a través del mejoramiento continuo"</i></h3>
            </header>
            <br><br>
