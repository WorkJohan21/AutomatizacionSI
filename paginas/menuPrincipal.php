...
<body class="cuerpo">
    ...
    <br>
            ...
            <div class="cajaopc">
                <a href="formEquipo2.php"><button class="opciones"><img src="../imagenes/formulario.png" width="30px" height="30px"><h5 class="textocuerpoBlack">Formulario de Solicitud de Equipo</h5></button></a>
            </div>
