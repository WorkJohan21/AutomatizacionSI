...
if (isset ($_REQUEST['nomActividad'])&& isset($_REQUEST['lugarActividad']))
{
  ...
  $insercion = $conn->prepare("INSERT INTO `orden` (nombreActividad,fechaActividad,horaActividad,fechaRetiro,fechaDevolucion,idLugar, idFacultad) value (:actividad,:fecha,:hora,:fechaRetiro,:fechaDevolucion,:lugar,:unidad/*:observacion,*/)");
